...
* ``qugar.dolfinx.dsu`` (integration on the unfitted
  boundary)
* ``qugar.dolfinx.UnfittedNormal`` (the physical normal at the
  unfitted boundary)
...
import qugar.impl
from qugar.dolfinx import dsu, UnfittedNormal  # importing qugar.dolfinx applies the assembly patches
